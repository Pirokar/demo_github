...
public class MarkdownConfiguration {
    ...
    protected MarkdownConfiguration(Header header, BlockQuote blockQuote, HorizontalRule horizontalRule,
                                    Code code, Todo _todo, UnOrderList unOrderList, Link link, Image image) {
        this.header = header;
    ...
    public static class Builder {
        ...
        public MarkdownConfiguration build() {
            return new MarkdownConfiguration(header, blockQuote, horizontalRule, code, todo, unOrderList, link, image);
        }
    }
}
