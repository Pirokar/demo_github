...
public final class ChatStyle implements Serializable {
    ...
    @BoolRes
    public int hideChatSubtitle = R.bool.threads_chat_hide_chat_subtitle;
...
//    R.drawable.timestamp_outgoing_underlayer - бэкграунд подложки под временем на исходящем сообщении с изображением
    ...
    public ChatStyle setHideChatSubtitle(@BoolRes final int hideChatSubtitle) {
        this.hideChatSubtitle = hideChatSubtitle;
        return this;
    }
