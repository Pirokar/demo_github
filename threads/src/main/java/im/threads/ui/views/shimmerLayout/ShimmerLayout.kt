...
internal class ShimmerLayout @JvmOverloads constructor(
    context: Context,
    ...
    fun ensureAnimationStarted() {
        if (!animating && width > 0 && isShown) {
            ...
            translateRange = width.coerceAtLeast(height)
    ...
    companion object {
        ...
        private val DEFAULT_COLOR = R.color.ecc_default_foreground_color
        private val DEFAULT_CENTER_WIDTH = R.dimen.ecc_shimmer_width_center_default
        private val DEFAULT_SHADOW_WIDTH = R.dimen.ecc_shimmer_width_default
    }
}
