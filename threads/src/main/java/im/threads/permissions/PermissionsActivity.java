...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private void showMissingPermissionDialog() {
        ...
        dialogBuilder.setTitle(R.string.lib_permissions_help);
        dialogBuilder.setMessage(getPermissionText());
        dialogBuilder.setNegativeButton(R.string.lib_permissions_quit, new DialogInterface.OnClickListener() {
            @Override
        ...
        dialogBuilder.setPositiveButton(R.string.lib_permissions_settings, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startAppSettings();
            }
    ...
    private int getPermissionText() {
        ...
        if(textId == TEXT_DEFAULT) {
            textId = R.string.lib_permissions_string_help_text;
        }
