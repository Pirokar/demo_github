...
public class ChatFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity instanceof ChatActivity) {
            ...
            ColorsHelper.setStatusBarColor(activity, android.R.color.darker_gray);
        }
    ...
    protected void setFragmentStyle(ChatStyle style) {
        ...
        if (style != null) {
            ...
            if (style.titleSizeInSp != ChatStyle.INVALID) {
                ...
                mWelcomeScreen.setTitletextSize(R.integer.title_size);
            }

            if (style.subtitleSizeInSp != ChatStyle.INVALID) {
                mWelcomeScreen.setSubtitleSize(style.subtitleSizeInSp);
            } else {
                mWelcomeScreen.setSubtitleSize(R.integer.subtitle_size);
            }
