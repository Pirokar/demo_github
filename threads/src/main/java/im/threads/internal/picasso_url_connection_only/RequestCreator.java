...
import static im.threads.internal.picasso_url_connection_only.MemoryPolicy.NO_CACHE;
import static im.threads.internal.picasso_url_connection_only.MemoryPolicy.NO_STORE;
import static im.threads.internal.picasso_url_connection_only.MemoryPolicy.shouldReadFromMemoryCache;
...
public class RequestCreator {
    ...
    public void into(ImageView target, Callback callback) {
        ...
        if (shouldReadFromMemoryCache(memoryPolicy)) {
            ...
            if (bitmap != null) {
                picasso.cancelRequest(target);
                PicassoDrawable.setBitmap(target, picasso.context, bitmap, Picasso.LoadedFrom.MEMORY, noFade, picasso.indicatorsEnabled);
                if (picasso.loggingEnabled) {
                    Utils.log(Utils.OWNER_MAIN, Utils.VERB_COMPLETED, request.plainId(), "from " + Picasso.LoadedFrom.MEMORY);
                }
                if (callback != null) {
