...
public class MyOpenHelperTest {
    ...
    public void testGetUnreadMessagesId() throws Exception {
        ConsultPhrase consultPhrase = new ConsultPhrase(null, null, "", "id1", "", 0L, "sdg", "", false, "",false);
        ConsultPhrase consultPhrase2 = new ConsultPhrase(null, null, "", "id2", "", 0L, "sdgwet", "", false, "",false);
        ...
        ConsultPhrase consultPhrase3 = new ConsultPhrase(null, null, "", "id3", "", 0L, "sdg", "", false, "",false);
        ConsultPhrase consultPhrase4 = new ConsultPhrase(null, null, "", "id4", "", 0L, "sdgwet", "", false, "",false);
