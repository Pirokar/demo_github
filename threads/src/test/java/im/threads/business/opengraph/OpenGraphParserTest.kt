...
class OpenGraphParserTest {
    ...
    private val mockedHtml = "<!DOCTYPE html>\n" +
        ...
        "<meta property=\"og:image\" content=\"https://edna.ru/wp-content/uploads/2021/03/120553885_1187468238300026_6630591726554696969_n.jpg\" />\n" +
        "<meta property=\"og:image:secure_url\" content=\"https://edna.ru/wp-content/uploads/2021/03/120553885_1187468238300026_6630591726554696969_n.jpg\" />\n" +
    ...
    @Test
    fun openGraphTest() {
        val parsedOgData = openGraphParser.getContents("http://localhost:8080/index")
        val isTitleOk = parsedOgData?.title == "edna - омниканальные коммуникации для работы с клиентами в цифровых каналах коммуникации"
        val isDescriptionOk = parsedOgData?.description == "edna (ранее MFMS) - лидер в сфере IT-решений для бизнеса в сфере неголосовых коммуникаций с 2005 года. Подключение и интеграция всех видов мессенджеров и цифровых каналов. Облачный чат-центр. Автоматизация и повышение эффективности бизнес-процессов. Официальный партнер Apple, Facebook, Viber, Vk-notify."
        val isImageUrlOk = parsedOgData?.imageUrl == "https://edna.ru/wp-content/uploads/2021/03/120553885_1187468238300026_6630591726554696969_n.jpg"
        val isUrlOk = parsedOgData?.url == "https://edna.ru/"
        val isSiteNameOk = parsedOgData?.siteName == "edna"
        val isTypeOk = parsedOgData?.type == "website"

        assert(isTitleOk && isDescriptionOk && isImageUrlOk && isUrlOk && isSiteNameOk && isTypeOk)
    }
}
