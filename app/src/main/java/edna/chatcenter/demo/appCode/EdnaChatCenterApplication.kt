package edna.chatcenter.demo.appCode
...
import edna.chatcenter.ui.core.config.transport.ChatSSLCertificate
...
class EdnaChatCenterApplication : Application() {
    ...
    override fun onCreate() {
        ...
        FirebaseCrashlytics.getInstance().setCrashlyticsCollectionEnabled(!edna.chatcenter.demo.BuildConfig.DEBUG)
        FirebasePerformance.getInstance().isPerformanceCollectionEnabled = !edna.chatcenter.demo.BuildConfig.DEBUG
...
const val ednaMockUrl = "${edna.chatcenter.demo.appCode.ednaMockScheme}://${edna.chatcenter.demo.appCode.ednaMockHost}:${edna.chatcenter.demo.appCode.ednaMockPort}/"
const val ednaMockThreadsGateUrl = "ws://${edna.chatcenter.demo.appCode.ednaMockHost}:${edna.chatcenter.demo.appCode.ednaMockPort}/gate/socket"
