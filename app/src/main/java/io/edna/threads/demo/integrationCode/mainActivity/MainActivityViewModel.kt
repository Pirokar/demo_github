package io.edna.threads.demo.integrationCode.mainActivity
...
class MainActivityViewModel(
    ...
    private fun initThreadsLib() {
        val loggerConfig = LoggerConfig.Builder(application.applicationContext)
            .logToFile()
            .dir(File(application.applicationContext.filesDir, "logs"))
            .retentionPolicy(LoggerRetentionPolicy.TOTAL_SIZE)
            .maxTotalSize(5242880)
            .build()

        val configBuilder = ConfigBuilder(application.applicationContext)
